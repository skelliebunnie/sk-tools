...
function sk_datetime_shortcode($atts) {
	...
	if($sk_admin_options['enable_datetime'] === 'true') {
		...
		$sk_datetime_options = get_option('sk_datetime_options');
		$date_format = $sk_datetime_options['default_date_format'];
		$time_format = $sk_datetime_options['default_time_format'];
